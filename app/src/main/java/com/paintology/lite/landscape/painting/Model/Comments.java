...
public class Comments implements Parcelable {
    ...
    protected Comments(Parcel in) {
        ...
        post_comment_lists = in.createTypedArrayList(com.paintology.lite.landscape.painting.Model.post_comment_lists.CREATOR);
    }
    ...
    public ArrayList<com.paintology.lite.landscape.painting.Model.post_comment_lists> getPost_comment_lists() {
        return post_comment_lists;
    }

    public void setPost_comment_lists(ArrayList<com.paintology.lite.landscape.painting.Model.post_comment_lists> post_comment_lists) {
