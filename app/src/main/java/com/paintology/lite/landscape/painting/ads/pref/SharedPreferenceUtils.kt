package com.paintology.lite.landscape.painting.ads.pref
...
class SharedPreferenceUtils(private val sharedPreferences: SharedPreferences) {
    ...
    internal val INTER_SPLASH_KEY = "interOnOff_lp"
    internal val BANNER_DASHBOARD_KEY = "bannerOnOff_lp"
    internal val NATIVE_COMMUNITY_KEY = "nativeOnOff_lp"
    internal val interRewardNotification = "interRewardOnOff_lp"
    internal val openApp = "openAdOnOff_lp"
    internal val interIDs = "interIDs_lp"
    internal val admobAppID = "admobAppID_lp"
    internal val interRewardIDs = "interRewardIDs_lp"
    internal val interProgressActivityRewardIDs = "interProgressActivityRewardIDs_lp"
    internal val interUserPointActivityRewardIDs = "interUserPointActivityRewardIDs_lp"
    internal val nativeIDs = "nativeIDs_lp"
    internal val bannerIDs = "bannerIDs_lp"
    internal val openAppIDs = "openAdID_lp"
