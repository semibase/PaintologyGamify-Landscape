...
import com.paintology.lite.landscape.painting.Model.SlideInfo;
...
import com.paintology.lite.landscape.painting.ads.callbacks.InterstitialOnLoadCallBack;
import com.paintology.lite.landscape.painting.ads.callbacks.InterstitialOnShowCallBack;
import com.paintology.lite.landscape.painting.ads.koin.DIComponent;
import com.paintology.lite.landscape.painting.databinding.ActivityFirstScreenBinding;
...
import com.paintology.lite.landscape.painting.ui.login.GuestUtils;
        ...
        mFirebaseRemoteConfig.fetchAndActivate()
                ...
                .addOnCompleteListener(this, new OnCompleteListener<Boolean>() {
                    ...
                    public void onComplete(@NonNull Task<Boolean> task) {
                        ...
                        int totalBanners = (int) mFirebaseRemoteConfig.getLong("total_lp_banners");
                        List<BannerModel> resBanners = new ArrayList<>();

                        for (int i = 1; i <= totalBanners; i++) {
                            String bannerImageUrl = mFirebaseRemoteConfig.getString("ad_lp_banner" + i + "_image").trim();
                            String bannerLInk = mFirebaseRemoteConfig.getString("ad_lp_banner" + i + "_link").trim();
                        ...
                        // get Onboarding Slider info
                        int totalDrawBanners = (int) mFirebaseRemoteConfig.getLong("draw_lp_total_banners");
                        List<BannerModel> drawBanners = new ArrayList<>();

                        for (int i = 1; i <= totalDrawBanners; i++) {
                            String bannerImageUrl = mFirebaseRemoteConfig.getString("draw_lp_banner" + i + "_image").trim();
                            String bannerLInk = mFirebaseRemoteConfig.getString("draw_lp_banner" + i + "_link").trim();
                        ...
                        int totalTutBanners = (int) mFirebaseRemoteConfig.getLong("tut_lp_total_banners");
                        List<BannerModel> tutBanners = new ArrayList<>();

                        for (int i = 1; i <= totalTutBanners; i++) {
                            String bannerImageUrl = mFirebaseRemoteConfig.getString("tut_lp_banner" + i + "_image").trim();
                            String bannerLInk = mFirebaseRemoteConfig.getString("tut_lp_banner" + i + "_link").trim();
