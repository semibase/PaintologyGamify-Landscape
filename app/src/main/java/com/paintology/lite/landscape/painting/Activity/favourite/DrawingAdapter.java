...
import static com.paintology.lite.landscape.painting.Activity.utils.ExtensionsKt.openActivity;
...
import com.paintology.lite.landscape.painting.Activity.gallery_activity.views.fragment.GalleryTutorailsFragment;
...
public class DrawingAdapter extends RecyclerView.Adapter<DrawingAdapter.DrawingViewHolder> {
    ...
    private List<com.paintology.lite.landscape.painting.Activity.gallery_activity.model.new_models.NewDrawing> drawings;

    public DrawingAdapter(Context context, List<com.paintology.lite.landscape.painting.Activity.gallery_activity.model.new_models.NewDrawing> drawings) {
    ...
    public void onBindViewHolder(DrawingViewHolder holder, @SuppressLint("RecyclerView") int position) {
        com.paintology.lite.landscape.painting.Activity.gallery_activity.model.new_models.NewDrawing drawing = drawings.get(position);
...
//        holder.appCompatImageView7.setText(drawing.getStatistic().getComments());
    ...
    public void setDrawings(List<com.paintology.lite.landscape.painting.Activity.gallery_activity.model.new_models.NewDrawing> drawings) {
        this.drawings = drawings;
