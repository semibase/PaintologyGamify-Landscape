...
//            db.close();
    ...
    public List<com.paintology.lite.landscape.painting.Activity.gallery_activity.model.new_models.NewDrawing> getAllDrawingsList() {
        List<com.paintology.lite.landscape.painting.Activity.gallery_activity.model.new_models.NewDrawing> drawings = new ArrayList<>();
        ...
        while (cursor.moveToNext()) {
            ...
            @SuppressLint("Range") com.paintology.lite.landscape.painting.Activity.gallery_activity.model.new_models.Images images = new com.paintology.lite.landscape.painting.Activity.gallery_activity.model.new_models.Images(cursor.getString(cursor.getColumnIndex(DrawingContract.DrawingEntry.COLUMN_IMAGES_CONTENT)));


            @SuppressLint("Range") com.paintology.lite.landscape.painting.Activity.gallery_activity.model.new_models.Metadata metadata = new com.paintology.lite.landscape.painting.Activity.gallery_activity.model.new_models.Metadata(
            ...
            @SuppressLint("Range")
            com.paintology.lite.landscape.painting.Activity.gallery_activity.model.new_models.Statistic statistic = new
                    com.paintology.lite.landscape.painting.Activity.gallery_activity.model.new_models.Statistic(
            ...
            @SuppressLint("Range") com.paintology.lite.landscape.painting.Activity.gallery_activity.model.new_models.Author author = new com.paintology.lite.landscape.painting.Activity.gallery_activity.model.new_models.Author(
            ...
            @SuppressLint("Range") com.paintology.lite.landscape.painting.Activity.gallery_activity.model.new_models.Links links = new com.paintology.lite.landscape.painting.Activity.gallery_activity.model.new_models.Links(cursor.getString(cursor.getColumnIndex(DrawingContract.DrawingEntry.COLUMN_LINKS_YOUTUBE)));

            com.paintology.lite.landscape.painting.Activity.gallery_activity.model.new_models.NewDrawing drawing = new com.paintology.lite.landscape.painting.Activity.gallery_activity.model.new_models.NewDrawing(author, createdAt, description, id, images, links, metadata, referenceId, statistic, tags, title, type);
