package com.paintology.lite.landscape.painting.Activity.gallery_activity.views.activities
...
import com.paintology.lite.landscape.painting.Activity.Lists.challengeLevelList
import com.paintology.lite.landscape.painting.Activity.favourite.DrawingRepository
import com.paintology.lite.landscape.painting.Activity.gallery_activity.adapter.CommentsAdapter
import com.paintology.lite.landscape.painting.Activity.gallery_activity.adapter.TagAdapter
import com.paintology.lite.landscape.painting.Activity.gallery_activity.model.Comment
...
import com.paintology.lite.landscape.painting.Activity.utils.Constants_Gallery
import com.paintology.lite.landscape.painting.Activity.utils.getUserOnlineStatus
import com.paintology.lite.landscape.painting.Activity.utils.getUserProfileData
import com.paintology.lite.landscape.painting.Activity.utils.hide
import com.paintology.lite.landscape.painting.Activity.utils.hideKeyboard
import com.paintology.lite.landscape.painting.Activity.utils.invisible
import com.paintology.lite.landscape.painting.Activity.utils.onSingleClick
import com.paintology.lite.landscape.painting.Activity.utils.onSingleClick1
import com.paintology.lite.landscape.painting.Activity.utils.openActivity
import com.paintology.lite.landscape.painting.Activity.utils.show
import com.paintology.lite.landscape.painting.Activity.utils.showPopupMenu
import com.paintology.lite.landscape.painting.Activity.utils.showToastRelease
import com.paintology.lite.landscape.painting.Activity.utils.startDrawingActivity
import com.paintology.lite.landscape.painting.Activity.utils.startDrawingActivityWithRank
...
import com.paintology.lite.landscape.painting.challenge.ChallengeLevelsModel
import com.paintology.lite.landscape.painting.challenge.adapter.ChallengeLevelsAdapter
import com.paintology.lite.landscape.painting.challenge.adapter.LevelClick
import com.paintology.lite.landscape.painting.data.db.FirebaseFirestoreApi
import com.paintology.lite.landscape.painting.data.db.FirebaseFirestoreApi.countDrawingView
import com.paintology.lite.landscape.painting.databinding.ActivityDrawingViewBinding
import com.paintology.lite.landscape.painting.databinding.LayoutBottomSheetChallengeBinding
                ...
                imgMenuDrawing.showPopupMenu(R.menu.drawing_screen_menu) {
                    ...
                    when (it.itemId) {
                        ...
                        R.id.addFav -> {
                            ...
                            val newDraw:com.paintology.lite.landscape.painting.Activity.favourite.NewDrawing =
                                com.paintology.lite.landscape.painting.Activity.favourite.NewDrawing(
                                    model.author,
                                    model.createdAt,
                                    model.description,
                                    model.id,
